...
class Tenant(Base):
    ...
    # Relationships
    client_account = relationship("ClientAccount", back_populates="tenants", lazy="noload")
    ...
    commands = relationship("CommandQueue", back_populates="tenant", lazy="noload")
    push_subscriptions = relationship("PushSubscription", back_populates="tenant", lazy="noload")
    alert_rules = relationship("AlertRule", back_populates="tenant", lazy="noload")
    proactive_alerts = relationship("ProactiveAlert", back_populates="tenant", lazy="noload")
