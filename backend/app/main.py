...
# from app.routers import change_requests  # temporarily disabled for debugging
...
# app.include_router(change_requests.portal_router)  # temporarily disabled
# app.include_router(change_requests.admin_router)  # temporarily disabled
